...
export const EXTERNAL_IMPORT_REASON = Object.freeze({
  ...
  /** A scope surface the facility graph does not hold. Reported, never thrown. */
  EXTERNAL_AVOID_SURFACE_UNKNOWN: 'EXTERNAL_AVOID_SURFACE_UNKNOWN',
...
export const EXTERNAL_IMPORT_REASON_SEVERITY = Object.freeze({
  ...
  [EXTERNAL_IMPORT_REASON.EXTERNAL_AVOID_SURFACE_UNKNOWN]: EXTERNAL_IMPORT_SEVERITY.BLOCKING,
