...
export default function DashboardLayout({ _activeSection }) {
  ...
  return (
    <div className={`flex min-h-screen ${isImpersonating ? 'pt-[48px]' : ''}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        {/* Mobile Header */}
        <div
          className={`md:hidden p-4 border-b border-border-subtle flex items-center justify-between bg-bg-app/95 backdrop-blur-xl sticky ${isImpersonating ? 'top-[48px]' : 'top-0'} z-30`}
        >
