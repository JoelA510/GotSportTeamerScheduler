...
*Real-time updates must feel instantaneous yet lightweight.*
...
*The "Single Source of Truth" must be the database, not the local state.*
...
*Overlays must provide value without obstructing core workflows.*
